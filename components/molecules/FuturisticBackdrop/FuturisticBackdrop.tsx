...
export function FuturisticBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      {/* 1. Vibrant Pulsing Comic-Arcade Light Glow Orbs */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, var(--glow-1, var(--primary)) 0%, color-mix(in srgb, var(--primary) 45%, transparent) 45%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, var(--glow-2, var(--secondary)) 0%, color-mix(in srgb, var(--secondary) 40%, transparent) 50%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, color-mix(in srgb, var(--primary-container, var(--primary)) 65%, transparent) 0%, transparent 65%)",
          }}
        />
      </div>

      {/* 2. Soft Light Diffusion Blanket */}
      <div className="absolute inset-0 backdrop-blur-[50px] sm:backdrop-blur-[70px]" />
    </div>
  );
}
